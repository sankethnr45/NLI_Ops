...
export async function fetchAssetStatus(assetId) {
...
export async function fetchMaintenanceHistory(assetId) {
...
export async function fetchHighVibrationAssets(minimumVibration) {
    logger.info("Fetching high vibration assets", { category: "service", operation: "fetch_vibration", minimumVibration });
    return callAlertsMcpTool("getHighVibrationAssets", minimumVibration === undefined ? {} : { minimumVibration });
}
